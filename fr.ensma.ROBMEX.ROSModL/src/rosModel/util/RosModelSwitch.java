 ...
 * @generated
 */
public class RosModelSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case RosModelPackage.ROS_PACKAGE: {
				RosPackage rosPackage = (RosPackage)theEObject;
				T result = caseRosPackage(rosPackage);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RosModelPackage.TOPIC: {
				Topic topic = (Topic)theEObject;
				T result = caseTopic(topic);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RosModelPackage.NODE: {
				Node node = (Node)theEObject;
				T result = caseNode(node);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RosModelPackage.MSG_DATA_STRUCT: {
				MsgDataStruct msgDataStruct = (MsgDataStruct)theEObject;
				T result = caseMsgDataStruct(msgDataStruct);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RosModelPackage.SRV_DATA_STRUCT: {
				SrvDataStruct srvDataStruct = (SrvDataStruct)theEObject;
				T result = caseSrvDataStruct(srvDataStruct);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RosModelPackage.SERVICE: {
				Service service = (Service)theEObject;
				T result = caseService(service);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RosModelPackage.ROS_SYSTEM: {
				RosSystem rosSystem = (RosSystem)theEObject;
				T result = caseRosSystem(rosSystem);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RosModelPackage.ATTRIBUTE: {
				Attribute attribute = (Attribute)theEObject;
				T result = caseAttribute(attribute);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RosModelPackage.SIMPLE_ATTRIBUTE: {
			...
			case RosModelPackage.COMPOSED_ATTRIBUTE: {
				ComposedAttribute composedAttribute = (ComposedAttribute)theEObject;
				T result = caseComposedAttribute(composedAttribute);
				if (result == null) result = caseAttribute(composedAttribute);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RosModelPackage.ATTRIBUTE_ARRAY: {
				AttributeArray attributeArray = (AttributeArray)theEObject;
				T result = caseAttributeArray(attributeArray);
				if (result == null) result = caseAttribute(attributeArray);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RosModelPackage.CONSTANT: {
				Constant constant = (Constant)theEObject;
				T result = caseConstant(constant);
				if (result == null) result = caseSimpleAttribute(constant);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Ros Package</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Ros Package</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseRosPackage(RosPackage object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Msg Data Struct</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Msg Data Struct</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseMsgDataStruct(MsgDataStruct object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Srv Data Struct</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Srv Data Struct</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSrvDataStruct(SrvDataStruct object) {
		return null;
	}
