 ...
 * </p>
 * <ul>
 *   <li>{@link processMaker.impl.GlobalVariableImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class GlobalVariableImpl extends VariableImpl implements GlobalVariable {
	...
	protected EClass eStaticClass() {
		return ProcessMakerPackage.Literals.GLOBAL_VARIABLE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessMakerPackage.GLOBAL_VARIABLE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ProcessMakerPackage.GLOBAL_VARIABLE__NAME:
				return getName();
		}
