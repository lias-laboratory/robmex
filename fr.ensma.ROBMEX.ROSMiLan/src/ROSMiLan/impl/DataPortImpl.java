 ...
 * </p>
 * <ul>
 *   <li>{@link ROSMiLan.impl.DataPortImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DataPortImpl extends MinimalEObjectImpl.Container implements DataPort {
	...
	protected EClass eStaticClass() {
		return ROSMiLanPackage.Literals.DATA_PORT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ROSMiLanPackage.DATA_PORT__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ROSMiLanPackage.DATA_PORT__NAME:
				return getName();
		}
